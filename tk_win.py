...
#---------------------------------------------------------------------------------------------------------------------------------------------------------  
    def register(self):
        ...
        CPassword = Entry(frame1, width=25, fg='black', bg='white', highlightthickness=0, border=0,show='*',font=('Popins', 11, 'italic'))
        ...
        RPassword = Entry(frame1, width=25, fg='black', bg='white', highlightthickness=0, border=0,show='*',font=('Popins', 11, 'italic'))
